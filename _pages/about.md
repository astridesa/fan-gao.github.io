...
📄 **[View my Google Scholar Profile](https://scholar.google.com/citations?user=TqvMfmoAAAAJ)** for a complete list of publications and citations.
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin: 20px 0;">
  <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px; border-radius: 8px; text-align: center;">
    <strong>📸 Photography Enthusiast</strong><br>
    <span style="font-size: 0.9em;">Capturing moments through the lens</span>
  </div>
  ...
  <div style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white; padding: 15px; border-radius: 8px; text-align: center;">
    ...
    <span style="font-size: 0.9em;">粤語 | 中文 | English | 日本語</span>
  </div>
</div>
...
<div style="text-align: center; margin: 20px 0;">
  📧 <strong>Email:</strong> <a href="mailto:g.ecc.u-tokyo.ac.jp">g.ecc.u-tokyo.ac.jp</a><br>
